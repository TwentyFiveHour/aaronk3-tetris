...
/**
 * Represents the J block in Tetris.
 * 
 * @author Aaron Kaufman
 *@version Winter 2012, 2/1/2012
 */
public final class JBlock extends Block
{
   ...
   */
  public JBlock(final int the_position_x, final int the_position_y)
  {
  ...
  private static Set<BlockElement> getBlockSet()
  {
    ...
    final BlockElement d = new BlockElement(0, 0);
