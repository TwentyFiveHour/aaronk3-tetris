...
/**
 * Represents the I block in Tetris.
 ...
 */
  private static Set<BlockElement> getBlockSet()
  {
    ...
    final BlockElement b = new BlockElement(1, 0);
    final BlockElement c = new BlockElement(1, 3);
